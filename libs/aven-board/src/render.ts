...
/**
 * Render GitHub-flavoured markdown to sanitized HTML and extract H1/H2/H3 anchors.
 * Mirrors the app's docs renderer so board docs read identically to the rest of AvenOS.
 */
export function renderWorkItemMarkdown(markdown: string): { html: string; toc: TocItem[] } {
