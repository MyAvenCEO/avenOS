...
const selectors: StyleDef['selectors'] = {
	...
	'.cv-hero-meta strong': { color: 'var(--text)', fontWeight: '600' },
	'.cv-parties': {
		display: 'grid',
	...
	'.cv-party-name': { fontSize: '15px', fontWeight: '700', lineHeight: '1.3', marginBottom: '4px' },
	'.cv-party-line': {
		fontSize: '12px',
		color: 'var(--muted)',
		lineHeight: '1.45',
	...
	'.cv-def-term': { fontWeight: '700', color: 'var(--text)' },
	...
	'.cv-clause-title': { fontSize: '14px', fontWeight: '700' },
	'.cv-clause-body': {
		fontSize: '13px',
		lineHeight: '1.55',
		whiteSpace: 'pre-line',
	...
	'.cv-subclause-label': { fontSize: '12px', fontWeight: '700', marginBottom: '4px', color: 'var(--muted)' },
	...
	'.cv-sign-name': { fontSize: '13px', fontWeight: '700' },
