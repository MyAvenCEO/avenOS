...
const selectors: StyleDef['selectors'] = {
	'.ch-title': { margin: '0', fontSize: 'var(--fs-hero)', fontWeight: '500', letterSpacing: 'var(--tracking-tight)' },
	...
	'.ch-row': { display: 'flex', flexDirection: 'column', gap: '4px', maxWidth: '80%', alignItems: 'flex-start' },
