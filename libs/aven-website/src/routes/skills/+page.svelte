									...
									<div class="flex items-center gap-3">
										...
										<div>
											...
											<p class="mt-1 text-[12px] text-foreground/52">
												{pub.skillCount}
												Skills insgesamt · {pub.featuredSlugs.length} im Spotlight
											</p>
										</div>
									</div>
								</div>
				...
				<div>
					<div class="mb-5 border-b border-border/30 pb-4">
						...
						<p class="mt-1 text-[13px] text-foreground/55">
							...
							Skill{catalogSkills.length === 1 ? '' : 's'}
							{#if visibleSkills.length !== catalogSkills.length}
								<span class="text-foreground/40"> ({visibleSkills.length} mit Spotlight)</span>
							{/if}
						</p>
					</div>
