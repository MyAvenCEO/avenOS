...
<div lang="de" class="min-h-screen bg-background text-foreground font-sans antialiased">
	...
	<section class="border-b border-border/40 px-5 py-24 sm:px-8 sm:py-32 md:py-40">
		<div class="mx-auto max-w-3xl text-center">
			...
			<div class="mx-auto mt-8 max-w-xl">
				<div
					class="rounded-2xl border border-border/35 bg-white/55 px-5 py-5 text-left ring-1 ring-black/4 sm:px-6 sm:py-6"
				>
					...
					<p
						class="mt-3 font-serif text-[15px] italic leading-relaxed text-foreground/75 sm:text-[16px]"
					>
					...
					<div class="mt-4 flex items-center gap-2 border-t border-border/25 pt-3">
						...
						<p class="font-mono text-[9px] font-bold tracking-[0.14em] text-tuscan-sun">
	...
	>
		<div class="mx-auto max-w-2xl">
			<div class="text-center">
				...
				<p
					class="mx-auto mt-3 max-w-md font-mono text-[11px] font-bold uppercase tracking-[0.18em] text-tuscan-sun"
				>
	...
	>
		<div class="mx-auto max-w-3xl">
			...
			<div class="mt-8 grid gap-3 sm:grid-cols-3">
				...
				<div
					class="rounded-xl border border-tuscan-sun/30 bg-tuscan-sun/10 px-4 py-4 ring-1 ring-tuscan-sun/20"
				>
					<p class="font-mono text-[9px] font-bold uppercase tracking-[0.22em] text-tuscan-sun/70">
						Magic
					</p>
					<p class="mt-2 text-[13px] leading-snug text-foreground/78">
	...
	>
		<div class="mx-auto max-w-2xl">
			...
			<div
				class="mt-8 rounded-2xl border border-border/40 bg-white/55 p-5 ring-1 ring-black/5 sm:p-7"
			>
				<p class="font-mono text-[9px] font-bold uppercase tracking-[0.22em] text-foreground/40">
					...
					{#each skill.valueStack.standaloneAlternatives as alt (alt.label)}
						<li class="flex items-baseline justify-between gap-3">
							...
							{#if alt.eurPerMonth > 0}
								<span
									class="shrink-0 font-mono text-[13px] font-bold tabular-nums text-foreground/55 line-through decoration-foreground/30"
								>
									{alt.eurPerMonth}&nbsp;€/m
								</span>
							{:else}
								<span
									class="shrink-0 font-mono text-[11px] font-bold uppercase tracking-[0.12em] text-foreground/40"
								>
									Nicht verfügbar
								</span>
							{/if}
				...
				<div class="mt-5 flex items-baseline justify-between border-t border-border/30 pt-4">
					...
					<span
						class="font-mono text-xl font-bold tabular-nums text-foreground line-through decoration-foreground/40"
					>
				...
				<div class="mt-4 rounded-xl border border-tuscan-sun/40 bg-tuscan-sun/15 px-4 py-4">
					<p
						class="text-center font-mono text-[9px] font-bold uppercase tracking-[0.22em] text-tuscan-sun"
					>
				...
				<div class="mt-5 grid gap-3 border-t border-border/25 pt-5 sm:grid-cols-3">
					<div>
						<p class="font-mono text-[9px] font-bold uppercase tracking-[0.2em] text-foreground/38">
							Erste Entlastung
						</p>
				...
				<ul class="mt-3 space-y-2">
					{#each skill.bonuses as bonus (bonus)}
						<li class="flex gap-3 text-[13px] leading-snug text-foreground/76 sm:text-[14px]">
							<span
								class="mt-1 size-1.5 shrink-0 rounded-full bg-tuscan-sun"
								aria-hidden="true"
							></span>
							<span>{bonus}</span>
						</li>
	...
	>
		<div class="mx-auto max-w-2xl">
			...
			>
				<header class="flex items-end justify-between gap-4 border-b border-foreground/[0.06] pb-5">
					<div class="flex items-center gap-3">
						...
						<div>
							...
							<p class="mt-0.5 font-mono text-[13px] font-bold tracking-[0.1em] text-tuscan-sun">
								{skill.publisher.displayName}
							</p>
						</div>
					</div>
				...
				<p
					class="mt-6 font-serif text-[15px] italic leading-relaxed text-foreground/73 sm:text-[16px] sm:leading-[1.65]"
				>
				...
				<footer class="mt-8 border-t border-foreground/[0.06] pt-6">
					...
					<p class="mt-1.5 font-mono text-[13px] font-bold tracking-[0.1em] text-tuscan-sun">
						{skill.publisher.displayName}
					</p>
				</footer>
			</div>
	...
	<section class="border-b border-border/40 px-5 py-14 sm:px-8 sm:py-20">
		<div class="mx-auto max-w-2xl">
			...
			<div class="mt-6 text-center">
				<a
					href="/skills"
					class="font-mono text-[12px] font-semibold uppercase tracking-[0.14em] text-foreground/50 transition-opacity hover:text-foreground/80"
				>
					← Alle Skills ansehen
				</a>
			</div>
