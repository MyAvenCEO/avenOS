...
import { AvenUiEngine, type UiEvent, type UiFixtureShell } from './engine/index.js'
/**
...
let {
	...
	onState,
	class: className = '',
	desktopHint = 'This view runs in the desktop app.'
}: {
...
// Standalone runtime checks (no SvelteKit/$lib coupling): the QuickJS sandbox plugin
// only exists in the Tauri webview.
