...
pub(crate) const STORE_MANIFEST_KEY: &str = "__avendb_store_manifest";
const STORE_MANIFEST_MAGIC: &[u8; 10] = b"AVENDBSTO1";
...
pub(crate) fn scan_visible_region_row_batch_branches_with_storage<H: Storage + ?Sized>(
    storage: &H,
    table: &str,
    row_id: ObjectId,
