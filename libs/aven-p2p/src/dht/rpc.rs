...
use super::routing_table::{Node, RoutingTable, TableEvent};
...
impl DhtNode {
    ...
    fn handle_incoming_request(&mut self, req: super::io::IncomingRequest) {
        if req.internal {
            match req.command {
                CMD_PING => {
    ...
    fn handle_delayed_ping(&mut self, req: super::io::IncomingRequest) {
    ...
    fn handle_down_hint_request(&mut self, req: &super::io::IncomingRequest) {
    ...
    fn forward_user_request(&mut self, req: super::io::IncomingRequest) {
