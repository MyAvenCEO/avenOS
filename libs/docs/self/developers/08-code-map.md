...
| Concern | File |
|---------|------|
| SE key creation & ECDH/HKDF in Swift | `projects/tauri-plugin-self/swift-lib/Sources/SelfBridge/SelfBridge.swift` |
| macOS Tauri commands (register, unlock, public_key) | `projects/tauri-plugin-self/src/macos/commands.rs` |
