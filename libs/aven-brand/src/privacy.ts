 ...
 * URL, so no inline markup model is needed.
 */
import type { LegalDocument } from './legal.js'

export const DATENSCHUTZ_DE: LegalDocument = {
	slug: 'datenschutz',
	lang: 'de',
	...
	sections: [
		...
		{
			level: 3,
			title: 'Analyse-Tools und Tools von Dritt­anbietern',
			blocks: [
				{
					lines: [
		...
		},
		{
			...
			blocks: [
				{
					lines: ['Wir hosten die Inhalte unserer Website bei folgendem Anbieter:']
				}
			]
		},
		{
		...
		},
		{
			...
			blocks: [
				{
					lines: [
						'Wir nutzen das Content Delivery Network Bunny.net. Anbieter ist die BunnyWay d.o.o., Dunajska cesta 165, 1000 Ljubljana, Slovenia (nachfolgend „Bunny.net CDN“).'
					]
				},
				{
					lines: [
						'Bei Bunny.net CDN handelt es sich um ein weltweit verteiltes Content Delivery Network. Dabei wird technisch der Informationstransfer zwischen Ihrem Browser und unserer Website über das Content Delivery Network geleitet. Hierdurch können wir die weltweite Erreichbarkeit und die Leistungsfähigkeit unserer Website erhöhen. Das CDN erfasst die IP-Adresse, die jedoch anonymisiert wird. Zudem erfasst das CDN personenbezogene Daten, wenn diese selbst vom User eingegeben werden (z. B. durch Absenden über ein Kontaktformular auf der Website).'
					]
				},
				{
					lines: [
						'Der Einsatz von Bunny.net CDN beruht auf unserem berechtigten Interesse an einer möglichst fehlerfreien und sicheren Bereitstellung unseres Webangebotes (Art. 6 Abs. 1 lit. f DSGVO).'
					]
				},
				{
					lines: [
						'Weitere Informationen zu Bunny.net CDN finden Sie hier: https://bunny.net/privacy/.'
					]
				}
			]
		},
		...
		},
		{
			...
			blocks: [
				{
					lines: ['Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:']
				},
				{
					lines: ['avenCEO GmbH', 'Aventinstr. 8', '80469 München']
				},
				{
					lines: ['Telefon: +49 89 38466851', 'E-Mail: mail@aven.ceo']
				},
				{
					lines: [
		...
		{
			level: 3,
			title: 'Verschlüsselter Zahlungsverkehr auf dieser Website',
			blocks: [
				{
					lines: [
		...
		{
			level: 3,
			title: 'Einsatz von KI auf der Website',
			blocks: [
				{
					lines: ['Wir nutzen KI-gestützte Dienste und / oder Anwendungen auf unserer Website.']
				},
				{
					lines: ['Wir setzen Künstliche Intelligenz (KI) auf unserer Website wie folgt ein:']
				},
				{
					lines: [
						'- Kundensupport Tickets',
						'- Emails beantworten',
						'- Alle sonstigen Kundenanfragen und Aufträge'
					]
				},
				{
					lines: [
		...
		{
			level: 3,
			title: 'Einsatz von Künstlicher Intelligenz (KI) zur Beantwortung von Kundenanfragen',
			blocks: [
				{
					lines: [
				...
				{
					lines: ['Wir setzen folgende KI-Anwendungen ein:']
				}
			]
		},
		{
			...
			blocks: [
				{
					lines: [
						'Wir nutzen phala.com für unsere Kundenkommunikation. Anbieter ist Hashforest Technology LLC, Address: 39899 Balentine Drive Ste 200, Newark, CA 94560., Phone: +1 (341)228-6591. Wenn Sie also Kontakt zu uns aufnehmen, können Ihre Anfragen inklusive Metadaten an die Server dieses Anbieters übertragen und dort verarbeitet werden, um eine passende Antwort zu generieren.'
					]
				}
			]
		},
		...
		{
			level: 2,
			title: '5. eCommerce und Zahlungs­anbieter',
			blocks: []
		},
		{
			level: 3,
			title: 'Verarbeiten von Kunden- und Vertragsdaten',
			blocks: [
				{
					lines: [
		...
		{
			level: 3,
			title: 'Daten­übermittlung bei Vertragsschluss für Online-Shops, Händler und Warenversand',
			blocks: [
				{
					lines: [
...
export const PRIVACY_POLICY_EN: LegalDocument = {
	...
	sections: [
		...
		},
		{
			...
			blocks: [
				{
					lines: ['We are hosting the content of our website at the following provider:']
				}
			]
		},
		{
		...
		},
		{
			...
			blocks: [
				{
					lines: ['The data processing controller on this website is:']
				},
				{
					lines: ['avenCEO GmbH', 'Aventinstr. 8', '80469 München']
				},
				{
					lines: ['Phone: +49 89 38466851', 'E-mail: mail@aven.ceo']
				},
				{
					lines: [
		...
		{
			level: 3,
			title: 'Encrypted payment transactions on this website',
			blocks: [
				{
					lines: [
		...
		},
		{
			...
			blocks: [
				...
				{
					lines: ['This data is not merged with other data sources.']
				},
				{
					lines: [
		...
		{
			level: 3,
			title: 'Use of AI on the website',
			blocks: [
				{
					lines: ['We use AI-supported services and/or applications on our website.']
				},
				{
					lines: ['We use artificial intelligence (AI) on our website as follows:']
				},
				{
					lines: [
						'- Kundensupport Tickets',
				...
				{
					lines: [
						'When you interact or come into contact with elements on our website that use artificial intelligence (e.g. chatbot), your input, including metadata, is processed to generate an appropriate response or reaction.'
					]
				},
				{
					lines: [
						'The use of these AI-supported functions is based on Art. 6(1)(f) GDPR. We have a legitimate interest in using modern technologies on our website in order to improve our performance and services and to recognize new potential from the interaction with our customers. If consent is required, processing is carried out exclusively on the basis of Art. 6(1)(a) GDPR and Section 25(1) TDDDG. You can withdraw your consent at any time.'
					]
				},
				{
					lines: [
						'Further information on the data processing of this tool or service can be found in the corresponding section of this privacy policy.'
					]
				}
			]
		},
		{
			level: 3,
			title: 'Use of artificial intelligence (AI) to respond to customers',
			blocks: [
				{
					lines: [
				...
				{
					lines: ['We use the following AI applications:']
				}
			]
		},
		{
			...
			blocks: [
				{
					lines: [
						"We use phala.com for our customer communication. The provider is Hashforest Technology LLC, Address: 39899 Balentine Drive Ste 200, Newark, CA 94560., Phone: +1 (341)228-6591. This means that when you contact us, your requests, including metadata, may be transmitted to the provider's servers and processed there to generate a suitable response."
					]
				}
			]
		},
		...
		{
			level: 2,
			title: '5. eCommerce and payment service providers',
			blocks: []
		},
		{
			level: 3,
			title: 'Processing of Customer and Contract Data',
			blocks: [
				{
					lines: [
		...
		{
			level: 3,
			title: 'Data transfer upon closing of contracts for services and digital content',
			blocks: [
				{
					lines: [
