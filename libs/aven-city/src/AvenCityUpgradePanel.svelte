...
>
	<div class="avencity-panel__body">
		...
		<p
			class="avencity-panel__path-label avencity-panel__path-label--right avencity-panel__body-label-right"
		>
			Level {upgrade.level}
		</p>
...
.avencity-panel__hero-hearts {
	...
	border: 1.5px solid
		color-mix(in srgb, var(--color-border, #d8dde4) 88%, var(--color-brand-navy, #1e293b));
