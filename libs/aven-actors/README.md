...
The LLM tool list contains registered named methods, with their argument schemas.
It does not add a generic `send` wrapper; internal envelope delivery remains available
