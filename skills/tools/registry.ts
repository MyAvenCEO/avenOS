...
import { connectSkillsActor, editSkillActor, improveSkillActor, mintData, planApp, promoteApp, seedDataActor, syncActorsActor, wireActors } from './promote'
...
export const TOOL_ACTORS: Record<string, ToolActor> = {
	...
	sync_actors: syncActorsActor,
	connect_skills: connectSkillsActor,
	edit_skill: editSkillActor,
	ontology,
	query,
	mutate,
	bundle
...
export const SKILL_REGISTRY: Record<SkillId, { label: string; description: string; tools: string[] }> = {
	...
	skillify: {
		...
		tools: ['create_mockup', 'edit_mockup', 'mockups', 'plan_app', 'mint_data', 'wire_actors', 'seed_data', 'promote', 'improve_skill', 'sync_actors', 'connect_skills', 'edit_skill']
	}
}
