...
try:
    docker('run','--rm','-d','--name',NAME,'-e','POSTGRES_PASSWORD=synthetic-only','postgres:18-alpine@sha256:d3e1620b530c944afa6e887d22eb899824da68e19c52024bf98f5220c88a65b2')
    for _ in range(150):
