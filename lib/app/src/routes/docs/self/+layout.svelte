<script lang="ts">
	...
	import { founderDocs, developerDocs } from '$lib/docs/self-collection'

	let { children } = $props()

	const groups = [
		{ id: 'founders', label: 'Founders', docs: founderDocs, base: '/docs/self/founders' },
		{ id: 'developers', label: 'Developers', docs: developerDocs, base: '/docs/self/developers' },
	] as const
</script>
...
>
	...
	>
		...
		<!-- Mobile: accordion for both groups -->
		...
		<!-- Main content (article injected by child page) -->
