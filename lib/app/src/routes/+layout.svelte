...
<div class="box-border flex h-dvh max-h-dvh min-h-0 flex-col overflow-hidden bg-background">
	<header
		class="shrink-0 bg-background/90 px-4 pt-3 pb-2 backdrop-blur-sm sm:px-6"
	>
		<div
		...
		>
			...
			>
				<a
					...
					aria-current={intentsActive ? 'page' : undefined}>Intents</a>
				...
				<a
					...
					aria-current={docsActive ? 'page' : undefined}>Docs</a>
			</nav>
