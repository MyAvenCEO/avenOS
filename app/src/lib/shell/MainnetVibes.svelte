...
<div class="flex min-h-0 flex-1">
	...
	<div class="flex min-h-0 flex-1 flex-col">
		...
		{:else if selectedVibe === 'addressbook'}
			<div class="flex min-h-0 flex-1 flex-col overflow-y-auto p-4">
				<AddressbookVibe containerName="aven-vibes-tab-addressbook" />
			</div>
		{:else if selectedVibe === 'invoice-create'}
			<div class="flex min-h-0 flex-1 flex-col overflow-y-auto p-4">
				<InvoiceCreateVibe containerName="aven-vibes-tab-invoice-create" />
			</div>
		{/if}
	</div>
</div>
