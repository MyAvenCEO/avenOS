...
{#if !inTauri}
	<div class="text-muted-foreground flex min-h-[200px] flex-1 items-center justify-center px-4 text-center text-sm">
...
{:else}
	...
	{/if}
	<div {@attach attachHost} class="flex min-h-0 min-w-0 flex-1 flex-col overflow-auto {className}"></div>
{/if}
