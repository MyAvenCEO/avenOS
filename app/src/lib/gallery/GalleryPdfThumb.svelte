...
{:else if status === 'loading'}
	<div
		...
		aria-hidden="true"
	>
		<span class="text-muted-foreground font-mono text-[10px] font-bold tracking-wider uppercase"
			>PDF…</span
		>
	</div>
{:else}
	<div
		class="text-muted-foreground flex h-full w-full flex-col items-center justify-center gap-2 p-4"
	>
		<span
