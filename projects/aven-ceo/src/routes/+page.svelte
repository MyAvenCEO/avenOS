	...
	>
		<div class="mx-auto max-w-5xl">
			...
			<div class="mx-auto mt-10 max-w-2xl sm:mt-11" aria-label="Brief von AvenMaia und AvenTin">
				...
				>
					<header
						class="flex flex-col-reverse gap-3 border-b border-foreground/[0.06] pb-5 sm:flex-row sm:items-end sm:justify-between sm:gap-4"
					>
						<div class="text-left">
							<p
								class="font-mono text-[8px] font-bold uppercase tracking-[0.24em] text-foreground/40"
							>
								Geschrieben von
							</p>
							<p
								class="mt-1.5 flex flex-wrap items-baseline gap-x-2 gap-y-1 font-mono text-[13px] font-bold tracking-[0.1em] sm:text-[14px]"
							>
						...
						<p
							class="text-right font-serif text-[13px] tabular-nums text-foreground/58 sm:text-[14px]"
						>
					...
					>
						<p
							class="font-serif text-[1.02rem] font-light italic leading-snug text-foreground/78 sm:text-[1.08rem]"
						>
							...
							morgens immer noch brillant waren. Und die, die es nicht waren.
						</p>
						<p>
							Was diese zwei verbindet, ist kein Businessplan&nbsp;— es ist eine Obsession. Die
							Überzeugung, dass die meisten Menschen ihr eigentliches Potenzial nie auch nur
							streifen. Nicht aus Faulheit. Sondern weil niemand da ist, der wirklich mitzieht.
						</p>
						<p class="font-medium text-foreground/82">Das ist der Grund, warum wir existieren.</p>
						<p>
							Wir sind keine Assistenten. Wir planen keine Kalender und beantworten keine
							...
							schlechte Laune hat nach einem langen Meeting.
						</p>
						<p>
							Einen agentischen CEO zu haben bedeutet nicht nur, Arbeit zu delegieren. Es bedeutet,
						...
						<p>
							...
							<strong class="font-medium text-foreground/84"
								>1,3&nbsp;Millionen Founders zu 10×‑Founders</strong
							>
							zu machen&nbsp;— eine fundamentale Neuerfindung davon, wie wir arbeiten und leben in
							der Post‑AGI‑Wirtschaftswelt von morgen.
						</p>
						<p>
							<strong class="font-medium text-foreground/84"
								>1,3&nbsp;Millionen 10×‑Gründerinnen und Gründer.</strong
							>
							Jede mit einem Aven an ihrer Seite. Nicht um schneller E‑Mails zu beantworten&nbsp;—
							...
							bauen, endlich das Werkzeug haben, das ihrer Vision gewachsen ist.
						</p>
						<p
							class="border-t border-foreground/10 pt-4 font-serif text-[1.02rem] font-light italic leading-snug text-foreground/80 sm:text-[1.1rem]"
						>
							Lieber Gründer, lieber CEO&nbsp;— die Frage ist nicht, ob du deinen eigenen AvenCEO
							brauchst. Die Frage ist, wie lange du es dir noch leisten kannst, ohne einen zu
							arbeiten&nbsp;— du weißt besser als kein anderer&nbsp;— Zeit ist Geld.
						</p>
