<svelte:head>
	...
	<meta
		name="description"
		content="Wähle das Paket, das zu deiner unternehmerischen Phase passt — Founder, Startup oder Investor CEO. Sichere dir jetzt deine AvenID für 8 € statt 55 €."
	>
</svelte:head>
...
<div lang="de" class="min-h-screen bg-background text-foreground font-sans antialiased">
	...
	<section id="pricing-plans" class="scroll-mt-28 border-b border-border/40 px-5 py-14 sm:px-8 sm:py-16">
		<div class="mx-auto max-w-6xl">
			...
			<div class="mt-12 flex flex-col gap-5 lg:flex-row lg:gap-6 lg:items-stretch">
				...
				>
					{#if claimedName}
						<div class="mb-4 rounded-xl border border-tuscan-sun/50 bg-tuscan-sun/15 px-3 py-3 text-center">
							<p class="font-mono text-[9px] font-bold uppercase tracking-[0.22em] text-tuscan-sun">Deine Wahl</p>
				...
				<div class="grid min-w-0 flex-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:gap-5">
					<div class="flex min-w-0 flex-col rounded-2xl border border-border/45 bg-tuscan-sun/55 p-5 ring-1 ring-black/6">
						<div class="text-center">
							<p class="mt-2 text-lg font-bold uppercase tracking-[0.14em] text-foreground sm:text-xl sm:tracking-[0.12em]">
								Founder CEO</p>
						</div>
						...
						<ul class="mt-4 flex-1 space-y-1.5 text-left text-[12px] leading-snug text-foreground/75">
							<li>1 Aven ID</li>
							<li>KI inklusive: max. <strong class="font-medium text-foreground/82">1&nbsp;Std / Tag</strong>
								<span class="text-foreground/55">(~60&nbsp;Min.)</span></li>
					...
					<div class="flex min-w-0 flex-col rounded-2xl border border-border/40 bg-white/50 p-5 ring-1 ring-black/5">
						<div class="text-center">
							<p class="mt-2 text-lg font-bold uppercase tracking-[0.14em] text-foreground sm:text-xl sm:tracking-[0.12em]">
								Startup CEO</p>
						</div>
						...
						<ul class="mt-4 flex-1 space-y-1.5 text-left text-[12px] leading-snug text-foreground/75">
							<li>1 Aven ID</li>
							<li>KI inklusive: max. <strong class="font-medium text-foreground/82">4&nbsp;Std / Tag</strong>
								<span class="text-foreground/55">(~240&nbsp;Min.)</span></li>
							<li>5 Workspaces</li>
					...
					<div class="flex min-w-0 flex-col rounded-2xl border border-border/45 bg-white/55 p-5 ring-1 ring-black/5 sm:col-span-2 lg:col-span-1">
						<div class="text-center">
							<p class="mt-2 text-lg font-bold uppercase tracking-[0.14em] text-foreground sm:text-xl sm:tracking-[0.12em]">
								Investor CEO</p>
						</div>
						...
						<ul class="mt-4 flex-1 space-y-1.5 text-left text-[12px] leading-snug text-foreground/75">
							<li>1 Aven ID</li>
							<li>KI inklusive: bis zu <strong class="font-medium text-foreground/82">24&nbsp;Std / Tag</strong>
								<span class="text-foreground/55">(Fair‑Use)</span></li>
			...
			>
				<p class="text-center font-mono text-[10px] font-bold uppercase tracking-[0.28em] text-tuscan-sun sm:text-[11px]">
					OPTIONAL · MEHR KI + COACH PER MINUTE</p>
				<p class="mx-auto mt-2 max-w-2xl text-center font-mono text-[9px] font-medium uppercase tracking-[0.2em] text-foreground/45 sm:text-[10px]">
					Extra KI‑Minuten&nbsp;· höchst persönlicher Skill‑Support durch Samuel&nbsp;&amp; Daniel</p>
				<div class="mt-6 flex flex-col gap-8 lg:mt-8 lg:flex-row lg:items-stretch lg:gap-0 lg:divide-x lg:divide-border/35">
					<aside class="border-b border-border/35 pb-8 text-center lg:w-[min(17rem,38%)] lg:shrink-0 lg:border-b-0 lg:border-border/35 lg:pb-0 lg:pr-8 lg:text-left">
					...
					<div class="min-w-0 flex-1 lg:pl-8">
						<p class="mx-auto max-w-xl text-center text-[14px] font-medium leading-relaxed text-foreground/74 sm:text-[16px] sm:leading-snug lg:mx-0 lg:max-w-none lg:text-left">
						...
						<div class="mx-auto mt-6 grid max-w-sm grid-cols-1 gap-7 text-center sm:mt-8 sm:max-w-2xl sm:grid-cols-3 sm:gap-6 lg:mx-0">
							<div class="flex flex-col items-center gap-1 lg:items-start lg:text-left">
								...
								<p class="text-[11px] font-medium tabular-nums tracking-tight text-foreground/42 sm:text-[12px]">≈ 180&nbsp;€/h</p>
							</div>
							<div class="flex flex-col items-center gap-1 lg:items-start lg:text-left">
								...
								<p class="text-[11px] font-medium tabular-nums tracking-tight text-foreground/42 sm:text-[12px]">≈ 240&nbsp;€/h</p>
							</div>
							<div class="flex flex-col items-center gap-1 lg:items-start lg:text-left">
								...
								<p class="text-[11px] font-medium tabular-nums tracking-tight text-foreground/42 sm:text-[12px]">≈ 300&nbsp;€/h</p>
							</div>
						</div>
					</div>
				</div>
				<div class="mx-auto mt-8 flex w-full max-w-none flex-col items-center gap-4 border-t border-border/35 pt-5 text-center">
